...
var Register = function () {
    ...
    return (react_1.default.createElement("div", { className: "h-screen flex" },
        ...
        react_1.default.createElement("div", { className: "w-1/2 flex justify-center items-center bg-gray-800" },
            react_1.default.createElement(formik_1.Formik, { initialValues: initialValues, validationSchema: RegisterSchema, onSubmit: handleSubmit }, function (_a) {
                var isSubmitting = _a.isSubmitting;
                return (react_1.default.createElement(formik_1.Form, { className: "w-3/4 max-w-md" },
                    react_1.default.createElement("h1", { className: " flex items-center text-white justify-center text-3xl mb-5 " }, "Register"),
                    react_1.default.createElement("div", { className: "flex flex-col gap-4" },
                        ...
                        react_1.default.createElement("div", { className: "flex flex-col" },
                            react_1.default.createElement("label", { htmlFor: "password", className: "mb-1 text-white" }, "Confirm Password"),
                            react_1.default.createElement(formik_1.Field, { type: "password", name: "confirmPassword", className: "rounded-lg w-full h-12 p-2" }),
                            react_1.default.createElement(formik_1.ErrorMessage, { name: "confirmPassword", component: "div", className: "text-red-500" })),
